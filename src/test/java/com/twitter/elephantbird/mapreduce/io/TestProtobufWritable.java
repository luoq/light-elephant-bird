...
public class TestProtobufWritable {
  ...
  public static void setUp() {
    ...
    .addPhone(Person.PhoneNumber.newBuilder().setType(Person.PhoneType.MOBILE).setNumber("2930423").build())
    .addPhone(Person.PhoneNumber.newBuilder().setType(Person.PhoneType.HOME).setNumber("214121").build())
    .build();
    ...
    .addPhone(Person.PhoneNumber.newBuilder().setType(Person.PhoneType.MOBILE).setNumber("030303").build())
    .build();
